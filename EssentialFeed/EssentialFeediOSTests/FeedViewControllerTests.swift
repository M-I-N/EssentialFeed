...
private extension FeedViewController {
    func simulateAppearance() {
        if !isViewLoaded {
            loadViewIfNeeded()
            replaceRefreshControlWithFakeOne()
        }
    ...
    func replaceRefreshControlWithFakeOne() {
...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadingFeedIndicatorIsVisibleWhileLoadingFeed() {
        ...
        XCTAssertEqual(sut.isShowingLoadingIndicator, true, "Expected loading indicator once view appears")
